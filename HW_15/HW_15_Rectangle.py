...
if __name__ == '__main__':
    ...
    parser.add_argument('-a1', type=str, default='4')
    parser.add_argument('-b1', type=str, default='14')
    parser.add_argument('-a2', type=str, default='6')
    parser.add_argument('-b2', type=str, default='9')
